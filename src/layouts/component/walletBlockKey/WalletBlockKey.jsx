...
function WalletBlockKey({...props}) {
    ...
    return (
        <div className="BlockTop d-flex flex-column">
            {!isCustomKey && (
                <>
                    <span className='text-label my-3'>Wallet key</span>
                    <div className='text-white mb-4'>
                        <span>
                        This key will protect your asset from fraudulent. Click "Generate" to get one. 
                        </span>
            ...
            {isCustomKey && (
                <>
                    <span className='text-label my-3'>custom Wallet key</span>
                    <div className='text-white mb-4'>
                        <span>
