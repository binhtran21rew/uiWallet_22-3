...
function WalletBlockTimeKey({...props}) {
    ...
    return (
        <div className="BlockTop d-flex flex-column">
            <span className="text-label my-3">Wallet time key</span>
            <div className="text-white mb-4">
                <span>
                    Select your suitable lock period with lock time function.
                </span>
...
export default WalletBlockTimeKey;
